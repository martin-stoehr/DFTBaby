...
def norm(alpha, xxx_todo_changeme):
    # eqn. (2.2) from THO paper
    (l,m,n) = xxx_todo_changeme
...
def overlap_unnorm(alpha1, xxx_todo_changeme1,A,alpha2, xxx_todo_changeme2,B):
    """overlap without normalization constants. Taken from THO eq. 2.12"""
    (l1,m1,n1) = xxx_todo_changeme1
    (l2,m2,n2) = xxx_todo_changeme2
    rab2 = dist2(A,B)
    gamma = alpha1+alpha2
...
def overlap(alpha1, xxx_todo_changeme3,A,alpha2, xxx_todo_changeme4,B):
    """
    ...
    scalar, <g1|g2>
    """
    (l1,m1,n1) = xxx_todo_changeme3
    (l2,m2,n2) = xxx_todo_changeme4
...
def dipole(alpha1, xxx_todo_changeme5,A1, alpha2, xxx_todo_changeme6,A2):
    """dipole matrix element between two Gaussian orbitals"""
    (l1,m1,n1) = xxx_todo_changeme5
    (l2,m2,n2) = xxx_todo_changeme6
...
def coulomb_repulsion(xxx_todo_changeme7,norma, xxx_todo_changeme8,alphaa, xxx_todo_changeme9,normb, xxx_todo_changeme10,alphab, xxx_todo_changeme11,normc, xxx_todo_changeme12,alphac, xxx_todo_changeme13,normd, xxx_todo_changeme14,alphad):

    (xa,ya,za) = xxx_todo_changeme7
    (la,ma,na) = xxx_todo_changeme8
    (xb,yb,zb) = xxx_todo_changeme9
    (lb,mb,nb) = xxx_todo_changeme10
    (xc,yc,zc) = xxx_todo_changeme11
    (lc,mc,nc) = xxx_todo_changeme12
    (xd,yd,zd) = xxx_todo_changeme13
    (ld,md,nd) = xxx_todo_changeme14
